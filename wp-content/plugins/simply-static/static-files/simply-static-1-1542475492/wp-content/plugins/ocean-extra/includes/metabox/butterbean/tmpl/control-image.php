...
<# if ( data.src ) { #>
	<img class="butterbean-img" src="/https://zakprofessional.github.io/zkr-purchasing/wp-content/plugins/ocean-extra/includes/metabox/butterbean/tmpl/{{ data.src }}" alt="{{ data.alt }}" />
<# } else { #>
