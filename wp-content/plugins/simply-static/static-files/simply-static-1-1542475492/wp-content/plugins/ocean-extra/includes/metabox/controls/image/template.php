...
<div class="oceanwp-mb-field">
	...
	<# if ( data.src ) { #>
		<img class="butterbean-img" src="/https://zakprofessional.github.io/zkr-purchasing/wp-content/plugins/ocean-extra/includes/metabox/controls/image/{{ data.src }}" alt="{{ data.alt }}" />
	<# } else { #>
